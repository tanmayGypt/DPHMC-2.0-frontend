import Search_Order from "./Search";
export default function MyOrders() {
  return (
    <>
      <div className="py-14 px-4 md:px-6 2xl:px-20 2xl:container 2xl:mx-auto">
        <div className="flex justify-start item-start space-y-2 flex-col">
          <h1 className="text-3xl text-center dark:text-white lg:text-4xl font-semibold leading-7 lg:leading-9 text-gray-800">
            Your Orders
          </h1>
          <Search_Order />
        </div>
                  ...
                  <div className="w-full flex flex-col justify-start items-start space-y-8">
                    ...
                    <div className="flex justify-start items-start flex-col space-y-2">
                      <p className="text-sm dark:text-white text-gray-800 font-light">
                        ...
                        nutrients are just some of the factors that can leave us
                        feeling under par.
                      </p>
